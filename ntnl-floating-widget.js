// NTNL Floating Widget JavaScript - Self-contained Shadow DOM implementation
...
console.log('📜 NTNL Widget Script Loaded Successfully');
...
function initializeShadowDOM() {
    try {
        ...
        widgetContainer = document.getElementById('ntnlChatWidget');
        if (!widgetContainer) {
            console.error('Widget container #ntnlChatWidget not found in DOM');
            return false;
        }

        console.log('🔨 Creating Shadow DOM for NTNL widget...');
        ...
        const widgetHTML = `
            <div class="cts-chat-widget" id="ntnlChatWidgetInner" style="opacity: 0; transition: opacity 0.3s ease;">
                <div class="cts-widget-content">
                    <div class="cts-widget-header">
                        <span>🤖 Ask NTNL Assistant</span>
                    ...
                    <div class="cts-widget-body">
                        <div class="cts-widget-help" id="ctsWidgetHelp">
                            <div class="cts-help-text">
                                Hi! I'm NTNL Assistant, your Lutheran AI helper. I can assist with questions about faith, theology, and church life. Here are a couple of examples of what you can ask me:
                            </div>
                            <div class="cts-help-examples">
                                <div class="cts-help-example">
                                    "Tell me about ELCA values and beliefs"
                                </div>
                                <div class="cts-help-example">
...
function loadShadowCSS() {
    ...
    const widgetInner = shadowRoot.getElementById('ntnlChatWidgetInner');
    if (widgetInner) {
        ...
        <div id="cts-chat-interface" class="cts-chat-interface">
            ...
            <div id="cts-sidebar" class="cts-sidebar">
                <div id="cts-sidebar-content" class="cts-sidebar-content">
                    ...
                    <ul id="cts-canned-prompts-list">
                        <li><a href="#" class="cts-canned-prompt" data-prompt="Tell me about ELCA values and beliefs">ELCA Values</a></li>
                        <li><a href="#" class="cts-canned-prompt" data-prompt="What is the NTNL mission area?">About NTNL</a></li>
                        <li><a href="#" class="cts-canned-prompt" data-prompt="Tell me about women in ministry leadership">Women in Ministry</a></li>
                    </ul>
            ...
            <div id="cts-main-chat" class="cts-main-chat">
                <div id="cts-chat-header" class="cts-chat-header">
                    ...
                    <label for="cts-prompt-input" id="cts-chat-label">Ask NTNL Assistant:</label>
                </div>
            ...
            <div id="cts-about-panel" class="cts-about-panel">
                <div id="cts-about-content" class="cts-about-content">
                    ...
                    <h2>Hello, I'm NTNL Assistant!</h2>
                    <p>Hello! I'm NTNL Assistant, your AI helper. I can answer many kinds of questions and provide information to help you. Just type your question into the prompt and we can have a conversation about it!</p>
                    <div class="cts-examples">
                        <p><strong>Here are a couple examples of the sorts of things you can ask:</strong></p>
                        <div class="cts-example-prompt">"Tell me about ELCA values and beliefs and its mission"</div>
                        <div class="cts-example-prompt">"What is the role of women in ministry leadership?"</div>
                    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🚀 NTNL Widget: DOM loaded, initializing...');
    ...
    widget = shadowRoot.getElementById('ntnlChatWidgetInner');
    queryInput = shadowRoot.getElementById('ctsQueryInput');

    if (!widget) {
        console.error('NTNL widget not found');
        return;
    }
...
function runHealthCheck() {
    console.log('🏥 Running NTNL Widget Health Check...');
    ...
    console.table({
        ...
        widgetContainerExists: !!document.getElementById('ntnlChatWidget'),
