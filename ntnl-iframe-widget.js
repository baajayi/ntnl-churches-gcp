class SolaceAIWidget extends HTMLElement {
    constructor() {
        ...
        this.tenantId = this.getAttribute('tenant-id') || 'ntnl';
        this.widgetTitle = this.getAttribute('widget-title') || 'Ask NTNL Assistant:';
        this.aboutTitle = this.getAttribute('about-title') || 'Hello, I\'m NTNL Assistant!';
    }
        ...
        if (oldValue !== newValue) {
            switch (name) {
                case 'api-endpoint':
                    ...
                    break;
                case 'tenant-id':
                    this.tenantId = newValue || 'ntnl';
                    break;
                case 'widget-title':
                    this.widgetTitle = newValue || 'Ask NTNL Assistant:';
                    this.updateWidgetTitle();
                    break;
                case 'about-title':
                    this.aboutTitle = newValue || 'Hello, I\'m NTNL Assistant!';
    ...
    render() {
        this.shadowRoot.innerHTML = `
            <style>
                /* Mobile-First Responsive Design for NTNL Embed */
                    ...
                    <ul id="canned-prompts-list">
                        <li>
                            <a href="#" class="canned-prompt"
                               data-prompt="Tell me about ELCA and the NTNL mission area">
                                ELCA Values
                            </a>
                        </li>
                        <li>
                            <a href="#" class="canned-prompt"
                               data-prompt="What is the NTNL mission area?">
                                About NTNL
                            </a>
                        </li>
                        <li>
                            <a href="#" class="canned-prompt"
                               data-prompt="Tell me about women in ministry leadership">
                                Women in Ministry
                            </a>
                        </li>
                    </ul>
                    ...
                    <div id="about-content">
                        ...
                        <div class="examples">
                            ...
                            <div class="example-prompt">
                                "Tell me about ELCA and the NTNL mission area and its mission"
                            </div>

                            <div class="example-prompt">
                                "What is the role of women in ministry leadership?"
                            </div>
                        </div>
...
customElements.define('solace-ai-widget-ntnl', SolaceAIWidget);
